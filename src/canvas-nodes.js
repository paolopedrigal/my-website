...
export default class Nodes {
    ...
    spawnNodes() {
        for (let i = 0; i < this.numNodes; i++) {
            ...
            let x = randomInt(this.radius, window.innerWidth - this.radius); // guarantees to spawn strictly inside canvas
            let y = randomInt(this.radius, window.innerHeight - this.radius); // guarantees to spawn strictly inside canvas
